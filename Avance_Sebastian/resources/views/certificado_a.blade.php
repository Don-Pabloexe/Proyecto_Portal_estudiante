...
<html lang = "{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <!--Collapse Contenido-->
        ...
        <p class = "m-5">
            <a class = "btn btn-light p-3 mb-0 border-dark" style = "" data-bs-toggle = "collapse" href = "#collapseExample" role = "button" aria-expanded = "false" aria-controls = "collapseExample">
                Información General
            </a>
        </p>
    ...
    <!--Tercer Collapse--> 
        ...
        <p class = "mt-4">
            ...
            <div class = "collapse text-center" id = "collapseExample2" style = "">
