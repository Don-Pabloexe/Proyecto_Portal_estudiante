...
<html lang="en">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <!-- Logo de la universidad que al presionarlo lleva a la paguina oficial -->
        <div class="container-fluid">
            <a class="navbar-brand" href="https://www.uct.cl/%22%3E">
                <img src="Universidad_Catolica_de_Temuco_Logo_Vertical.png" width="150" height="50" class="d-inline-block align-top" alt="">
            </a>      
        </div>
